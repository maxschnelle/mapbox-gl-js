...
export type FogUniformsType = {|
    ...
    'u_haze_color': Uniform3f,
    'u_haziness': Uniform1f,
...
export const fogUniforms = (context: Context, locations: UniformLocations): FogUniformsType => ({
    ...
    'u_haze_color': new Uniform3f(context, locations.u_haze_color),
    'u_haziness': new Uniform1f(context, locations.u_haziness),
